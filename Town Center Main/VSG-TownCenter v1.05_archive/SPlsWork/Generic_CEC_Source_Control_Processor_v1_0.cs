...
namespace UserModule_GENERIC_CEC_SOURCE_CONTROL_PROCESSOR_V1_0
{
    public class UserModuleClass_GENERIC_CEC_SOURCE_CONTROL_PROCESSOR_V1_0 : SplusObject
    {
    ...
    public override object FunctionMain (  object __obj__ ) 
        ...
        try
        {
            ...
            Functions.ClearBuffer ( SOSDNAMETEMP ) ; 
    ...
    public UserModuleClass_GENERIC_CEC_SOURCE_CONTROL_PROCESSOR_V1_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
